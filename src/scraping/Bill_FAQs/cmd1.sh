curl 'https://help-qa.pge.com/s/sfsites/aura?r=9&ui-self-service-components-controller.TopicArticleListDataProvider.loadMoreArticles=1' \
  -H 'accept: */*' \
